...
//    }
    ...
    public void savePhoneDetails(PhoneDetailsDto phoneDetailsDto) {
        phoneDetailsRepository.save(new PhoneDetails(phoneDetailsDto.getName(),phoneDetailsDto.getBrand(),phoneDetailsDto.getPhoto(),phoneDetailsDto.getTechnolodgy(),phoneDetailsDto.getTwoGBands(),phoneDetailsDto.getThreeGBands(),phoneDetailsDto.getFourGBands(),phoneDetailsDto.getSpeed(),phoneDetailsDto.getGprs(),phoneDetailsDto.getEdge(),phoneDetailsDto.getAnnounced(),phoneDetailsDto.getStatus(),phoneDetailsDto.getDimentions(),phoneDetailsDto.getWeight(),phoneDetailsDto.getSim(),phoneDetailsDto.getType(),phoneDetailsDto.getSize(),phoneDetailsDto.getResolution(),phoneDetailsDto.getMultitouch(),phoneDetailsDto.getEmui(),phoneDetailsDto.getOs(),phoneDetailsDto.getChipset(),phoneDetailsDto.getCpu(),phoneDetailsDto.getGpu(),phoneDetailsDto.getCardslot(),phoneDetailsDto.getInternal(),phoneDetailsDto.getMainCamfeatures(),phoneDetailsDto.getMainCamVideos(),phoneDetailsDto.getSelfiCamFeatures(),phoneDetailsDto.getSelfieCamVideos(),phoneDetailsDto.getAlertType(),phoneDetailsDto.getLoudspeaker(),phoneDetailsDto.getLack(),phoneDetailsDto.getWlan(),phoneDetailsDto.getBluetooth(),phoneDetailsDto.getGps(),phoneDetailsDto.getRadio(),phoneDetailsDto.getUsb(),phoneDetailsDto.getSensorsMessaging(),phoneDetailsDto.getBrowser(),phoneDetailsDto.getColor(),phoneDetailsDto.getOther(),phoneDetailsDto.getPrice()));
    }
    ...
    public PhoneDetailsDto findPhoneDetails(String name) {
        ...
        System.out.println(phoneDetailsDto.getBrand());
        return new PhoneDetailsDto(phoneDetailsDto.getName(),phoneDetailsDto.getBrand(),phoneDetailsDto.getPhoto(),phoneDetailsDto.getTechnolodgy(),phoneDetailsDto.getTwoGBands(),phoneDetailsDto.getThreeGBands(),phoneDetailsDto.getFourGBands(),phoneDetailsDto.getSpeed(),phoneDetailsDto.getGprs(),phoneDetailsDto.getEdge(),phoneDetailsDto.getAnnounced(),phoneDetailsDto.getStatus(),phoneDetailsDto.getDimentions(),phoneDetailsDto.getWeight(),phoneDetailsDto.getSim(),phoneDetailsDto.getType(),phoneDetailsDto.getSize(),phoneDetailsDto.getResolution(),phoneDetailsDto.getMultitouch(),phoneDetailsDto.getEmui(),phoneDetailsDto.getOs(),phoneDetailsDto.getChipset(),phoneDetailsDto.getCpu(),phoneDetailsDto.getGpu(),phoneDetailsDto.getCardslot(),phoneDetailsDto.getInternal(),phoneDetailsDto.getMainCamfeatures(),phoneDetailsDto.getMainCamVideos(),phoneDetailsDto.getSelfiCamFeatures(),phoneDetailsDto.getSelfieCamVideos(),phoneDetailsDto.getAlertType(),phoneDetailsDto.getLoudspeaker(),phoneDetailsDto.getLack(),phoneDetailsDto.getWlan(),phoneDetailsDto.getBluetooth(),phoneDetailsDto.getGps(),phoneDetailsDto.getRadio(),phoneDetailsDto.getUsb(),phoneDetailsDto.getSensorsMessaging(),phoneDetailsDto.getBrowser(),phoneDetailsDto.getColor(),phoneDetailsDto.getOther(),phoneDetailsDto.getPrice());
